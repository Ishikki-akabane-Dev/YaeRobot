import importlib, re
from Yae import dispatcher, ALLOW_EXCL, LOGGER
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, ParseMode, Update
from Yae.Handlers.misc import paginate_modules
...
HELP_STRINGS = """Hi Bᴀᴇ! I'ʍ *Ruka Sarashina*[.](https://te.legra.ph/file/81c371405ea1987d55d90.jpg)
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        if len(args) >= 2 and any(args[1].lower() == x for x in HELPABLE):
            ...
            return
        update.effective_message.reply_text(
            "Contact me in PM to get the list of possible commands[.](https://telegra.ph/file/6ae8c19a33290158b3970.jpg)",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
